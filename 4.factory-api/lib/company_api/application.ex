defmodule CompanyApi.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # CompanyApi.Repo, # disable this line to don' use database in this project
      # Start the Telemetry supervisor
      CompanyApiWeb.Telemetry,
      # Start the Telemetry supervisor
      # CompanyApiWeb.FectoryWorkerSupervisor,
      {CompanyApi.FactoryWorkerSupervisor, name: WorkerSupervisor},
